...
class GameWindow(arcade.Window):
    ...
    #def on_update(self):
        ...
        coin_hit_list = arcade.check_for_collision_with_list(self.player_list[0], self.item_list)
    ...
    def on_draw(self):
        ...
        arcade.draw_text(score_text, 50, 500, arcade.csscolor.YELLOW, 25)
